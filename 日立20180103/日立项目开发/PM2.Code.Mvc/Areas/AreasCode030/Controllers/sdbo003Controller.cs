...
namespace PM2.WebApp.Areas.Code030.Controllers
{
    public class sdbo003Controller : Controller
    {
        ...
        {
            //IOperateResult result = this._sdbo003Server.SpecialNotes(context);

            //Gmail.DDD.JsonConvert.TreeJsonConvert o = result.GetResult<Gmail.DDD.JsonConvert.TreeJsonConvert>();

            //var e = o.rows as List<szrl086>;
            //return null;
        ...
        #region 与上一版本对比
        public ActionResult GetpvcnbInfo(HttpCollection context)
        {
            return this._sdbo003Server.GetpvcnbInfo(context)
                        .ToActionResult(this.ControllerContext);
        }
        #endregion
        /// <summary>
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ActionResult GetSzrl019Info(PageCollection context)
        {
            return this._sdbo003Server.GetSzrl019Info(context)
                       .ToActionResult(this.ControllerContext);
        }

        public ActionResult Get_partial(HttpCollection context)
        {
            Dictionary<string, string> dic = this._sdbo003Server.Get_partial(context);
            return Json(dic);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult AjMenu()
        {
            IEnumerable<szrl112> list = this._sdbo003Server.AjMenu();
            return Json(list);
        }
    }
}