...
select 
	rl14001, --ID
	rl14002, --主表ID szrl125.rl12501
	rl14003, --初始来源 0:合同支付计划, 1:合同验收计划, 2: 自定义新增
	rl14004, --来源ID  
	
	rl14005, --支付济 0: 金回支付, 1: 今后支付预定
	--元支付预定
	rl14006, --支付日期
	rl14007, --%
	rl14008, --金额
	...
	rl14013, --附件ID
	rl14014, --付款性质 0: 预付款, 1:质保款, 2:验收款
	rl14015, --预付款扣款金额
	rl14016, --预付款扣款占合同%
	rl14017, --本次实际支付金额(含税)
	rl14018, --本次实际支付金额(不含税)
	
	rl14019, --备注
	rl14020, --担当者 sdpj004.pj00401
	
	rl14021, --[废除]是否正式数据 0: 否, 1: 是
	rl14022  --排序序号
