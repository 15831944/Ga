...
namespace PM2.Service.Code030
{
    public class sdbo003Server : Isdbo003Server
    {
        ...
        private IEFRepository<szrl006> _szrl006Repository;

        private string[] rl08302s_or = new string[] { "K", "L", "B", "D", "E" };
        private string[] rl08303s_or = new string[] { "A1", "M1", "E1", "P", "T1" };
        ...
        public sdbo003Server(
            ...
            IEFRepository<szrl006> szrl006Repository,
        ...
        )
        {
            ...
            this._szrl006Repository = szrl006Repository;
            this._excelService = excelService;
        }
        #endregion
        #region =================================表纸=================================

        public Dictionary<string, string> Get_partial(IRequestGetter vParams)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    szrl025 _szrl025s = this._szrl025Repository.GetModels(x => x.rl02501.Equals(zuofanid) && x.rl02532.Equals(1)).OrderByDescending(x => x.rl02503).FirstOrDefault();
                    IQueryable<szrl018> sql_szrl018 = this._szrl018Repository.GetModels(x => x.rl01801.Equals(zuofanid));
                    decimal _rl01835 = sql_szrl018.Select(x => x.rl01835).FirstOrDefault();
                    decimal rl01813 = sql_szrl018.Select(x => x.rl01813).FirstOrDefault();
                    dic.Add("rl01813", rl01813.ToRound(2).ToString());
                    dic.Add("rl08217", _szrl025s.rl02520.ToRound(2).ToString());
                    dic.Add("rl08218", (_szrl025s.rl02520 * ((_rl01835 / 100) / (1 + _rl01835 / 100))).ToRound(2).ToString());
                    dic.Add("rl08219", (_szrl025s.rl02520 - (_szrl025s.rl02520 * ((_rl01835 / 100) / (1 + _rl01835 / 100)))).ToRound(2).ToString());
                    return dic;
                }
            }
            catch
        ...
        public IOperateResult GetImplementBudgetInfo(IRequestGetter vParams)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    string _versioNnumber = vParams.GetValue<string>("versioNnumber");
                    ...
                    szrl082 query_szrl082 = this._szrl082Repository.GetModels(x => x.rl08204.Equals(zuofanid) && x.rl08203.Equals(_versioNnumber)).FirstOrDefault();
                    ...
                    {
                        if (Convert.ToInt32(_versioNnumber) > 0)
                        {
                            query_szrl082.rl08202 = this._szrl082Repository.GetModels(x => x.rl08204.Equals(zuofanid) && x.rl08203.Equals("000000")).Select(x => x.rl08202).FirstOrDefault();
                        }
            ...
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    else
                    {
                        ...
                        if (_genre.Equals(0))
                        {
                            return this._szrl112Repository.GetModels(x => x.rl11204.Equals(two_name) && x.rl11205.Equals(t1)).Select(x => x.rl11203).FirstOrDefault() + two_name;
                        }
        ...
        /// 补全信息
        /// </summary>
        private List<T> ComplementaryInformation<T>(List<T> _list)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    if (_type.Name == "szrl083")
                    {
                        List<szrl083> list = _list.OfType<szrl083>().ToList();
                        foreach (szrl083 item in list)
                        {
                            szrl083 ent_szrl083 = this._szrl083Repository.GetModels(x => x.rl08305.Equals(item.rl08305)).FirstOrDefault();
                            if (ent_szrl083 != null)
                            {
                                item.rl08302 = ent_szrl083.rl08302;
                                item.rl08303 = ent_szrl083.rl08303;
                            }
                        }
                        return (List<T>)(object)list;
                    }
                    if (_type.Name == "szrl084")
                    {
                        List<szrl084> list = _list.OfType<szrl084>().ToList();
                        foreach (var item in list)
                        {
                            item.rl08404 = string.Empty;
                            item.rl08405 = string.Empty;
                            item.rl08407 = string.Empty;
                        }
                        return (List<T>)(object)list;
                    }
                }
        ...
        public IOperateResult Add(IRequestGetter context, szrl082 _szrl082)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    List<szrl083> _szrl083s = context.GetValue<List<szrl083>>("p1", GetterType.JToken) ?? new List<szrl083>();//接收json
                    List<szrl084> _szrl084s = context.GetValue<List<szrl084>>("p2", GetterType.JToken) ?? new List<szrl084>();//接收json
                    _szrl083s = ComplementaryInformation(_szrl083s);
                    _szrl084s = ComplementaryInformation(_szrl084s);
                    ...
                    List<string> p9 = context.GetValue<List<string>>("p9", GetterType.JToken);//klbde明细导入有变化的值
                    List<string> p10 = context.GetValue<List<string>>("p10", GetterType.JToken);//aj明细导入有变化的值
                    List<string> p11 = context.GetValue<List<string>>("p11", GetterType.JToken);//计划进度值
                    string _versioNnumber = context.GetValue<string>("p12");//版本号
                    string _changeType = context.GetValue<string>("p13");//变更类型
                    string _rl08235 = context.GetValue<string>("p14");//变更理由
                    string _kp = context.GetValue<string>("p15");//提交前kp值
                    string _rl08202 = context.GetValue<string>("p16");//实行预算初回发行日
                    _szrl082.rl08235 = _rl08235;
                    _szrl082.rl08202 = _rl08202;
                    if (_changeType.Equals("订正"))
                    {
                        _szrl082.rl08213 = _versioNnumber.Substring(0, 2);
                    }
                    else if (_changeType.Equals("改定"))
                    {
                        _szrl082.rl08213 = _versioNnumber.Substring(2, 2);
                    }
                    else
                    {
                        _szrl082.rl08213 = string.Empty;
                    }
                    //判断klbde明细导入的税率是否正确
                    //判断导入或者添加的明细是否已经存在
                    ...
                    #endregion
                    string[] _param = new string[] { _zuofanid, _versioNnumber, _changeType };
                    #region 对明细重新计算赋值
                    SaveVoucher_083(_szrl083s, _param);
                    SaveVoucher_084(_szrl084s, _param);
                    SaveVoucher_086(_szrl086s, _param);
                    #endregion
                    ...
                    if (string.IsNullOrWhiteSpace(_szrl085.rl08501))
                    {
                        ...
                        _szrl085.rl08507 = _versioNnumber;
                    ...
                    string[] _rl08301s = _szrl083s.Select(s => s.rl08301).ToArray();
                    szrl018 query_szrl018 = this._szrl018Repository.GetModels(x => x.rl01801.Equals(_zuofanid)).FirstOrDefault();
                    //为城建税及び附加赋值准备
                    IQueryable<szrl083> sql_szrl083 = this._szrl083Repository.GetModels(x =>
                                                                                     x.rl08316.Equals(_zuofanid)
                                                                                      && x.rl08317.Equals(_versioNnumber)
                                                                                       && !_rl08301s.Contains(x.rl08301)
                                                                                       );
                    #region 此处只是klbde明细 还需添加aj明细 s1 s2可以删掉不等于j3的条件
                    decimal s1 = _szrl083s.Where(x => !x.rl08304.Substring(0, 2).Equals("J3")).Sum(x => x.rl08309);//所有含税金额
                                                                                                                   // decimal s2 = sql_szrl083.Where(x=> !_rl08301s.Contains(x.rl08301)).ToArray().Sum(x => x.rl08313);
                    decimal s2 = sql_szrl083.Where(x => !x.rl08304.Substring(0, 2).Equals("J3")).ToArray().Sum(x => x.rl08313);
                    #endregion
                    decimal y1 = _szrl083s.Where(x => !x.rl08304.Substring(0, 2).Equals("J3")).Sum(x => x.rl08313);//所有含税金额
                    decimal y2 = sql_szrl083.Where(x => !x.rl08304.Substring(0, 2).Equals("J3")).ToArray().Sum(x => x.rl08313);
                    decimal g1 = _szrl083s.Where(x => x.rl08304.Substring(0, 2).Equals("B1")).Sum(x => x.rl08309);//所有含税金额
                    decimal g2 = sql_szrl083.Where(x => x.rl08304.Substring(0, 2).Equals("B1")).ToArray().Sum(x => x.rl08313);
                    ...
                    decimal h2 = sql_szrl083.ToArray().Sum(x => x.rl08309);
                    decimal h3 = _szrl083s.Sum(x => x.rl08313);//所有含税金额
                    decimal h4 = sql_szrl083.ToArray().Sum(x => x.rl08313);
                    ...
                    if (string.IsNullOrWhiteSpace(_szrl082.rl08201))
                    {
                        ...
                        if (Convert.ToInt32(_versioNnumber).Equals(0))
                        {
                            _szrl082.rl08202 = string.Empty;
                        }
                        _szrl082.rl08203 = _versioNnumber;
                        _szrl082.rl08204 = _zuofanid;
                        _szrl082.rl08205 = DateTime.Now.ToString("yyyy-MM-dd");
                        _szrl082.rl08212 = string.Empty;
                        _szrl082.rl08226 = string.Empty;
                        //_szrl082.rl08227 = _rl08227s;
                        _szrl082.rl08234 = _changeType;
                        //_szrl082.rl08235 = "";
                        _szrl082.rl08236 = 0;
                        _szrl082.rl08237 = UserContext.Pj00402;
                        _szrl082.rl08238 = DateTime.Now.ToString("yyyy/MM/dd");
                        _szrl082.rl08239 = string.Empty;
                        _szrl082.rl08240 = string.Empty;
                        _szrl082.rl08241 = 0;
                        _szrl082.rl08242 = string.Empty;
                        _szrl082.rl08243 = string.Empty;
                        this._szrl082Repository.Add(_szrl082);
                    }
                    else
                    {
                        szrl082 ent_szrl082 = this._szrl082Repository.Find(x => x.rl08201.Equals(_szrl082.rl08201));
                    ...
                    Grid_Del(p9, p10, p11);
                    #region 验证判断,不通过则阻止保存
                    #region 判断变更类型是否正确
                    if (_changeType.Equals("改定") || _changeType.Equals("订正"))
                    {
                        string last_versionnumber = GetLastVersion(_param[0], _param[1], _param[2]);//获取上一个版本号
                        szrl082 _last_szrl082 = this._szrl082Repository.Find(x => x.rl08204.Equals(_param[0]) && x.rl08203.Equals(last_versionnumber));//前一版本
                        if (!_last_szrl082.rl08217.Equals(_szrl082.rl08217))
                        {
                            if (!_changeType.Equals("改定"))
                            {
                                return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "受注金额已发生变化,不可做" + _changeType + "变更!");
                            }
                        }
                        else
                        {
                            if (!_last_szrl082.rl08224.Equals(_szrl082.rl08224))
                            {
                                if (!_changeType.Equals("订正"))
                                {
                                    return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "受注金额未发生变化,粗利率发生变化,不可做" + _changeType + "变更!");
                                }
                            }
                        }
                    }
                    ...
                    if (Convert.ToInt32(_versioNnumber) > 0)
                    {
                        if (string.IsNullOrWhiteSpace(_szrl082.rl08235))
                        {
                            return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "请填写变更理由!");
                        }
                    }
                    #endregion
                    #region klbde明细数量小于采购申请数量
                    if (_changeType.Equals("订正") || _changeType.Equals("改定"))
                    {
                        IQueryable<szrl006> _szrl006s = from x in this._szrl005Repository.GetModels()
                                                        join y in this._szrl006Repository.GetModels()
                                                        on x.rl00501 equals y.rl00602
                                                        where x.rl00505.Equals(_zuofanid)
                                                        select y;//获取到采购申请的信息
                        foreach (var item in _szrl083s)
                        {
                            szrl006 _szrl006 = _szrl006s.Where(x => x.rl00604.Equals(item.rl08304)).FirstOrDefault();//??获取对应明细的采购申请
                            if (_szrl006 != null)
                            {
                                IQueryable<szrl083> _s = sql_szrl083.Where(x => x.rl08304.Equals(item.rl08304));
                                decimal _s_1 = _s.Select(s => s.rl08307).FirstOrDefault();
                                if (_s_1 + item.rl08307 < _szrl006.rl00611)
                                {
                                    return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "件品名及摘要为 " + item.rl08305 + " 该项修改数量不能小于该项已经采购申请的数量");
                                }
                                decimal _s_2 = _s.Select(x => x.rl08309).FirstOrDefault();
                                if (_s_2 + item.rl08309 < _szrl006.rl00617)
                                {
                                    return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "件品名及摘要为 " + item.rl08305 + " 修改后的该项预算总金额不可小于该项已经采购申请的总金额");
                                }
                            }
                        }
                    }
                    #endregion
                    #region 变更类型为内部修正时,判断kp是否发生变化
                    if (_changeType.Equals("内部修正") && !_szrl082.rl08229.Equals(Convert.ToDecimal(_kp)))
                    {
                        return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "KP数值发生变化，不可内部修正");
                    }
                    #endregion
                    #region 订正或者改定
                    if ((_changeType.Equals("订正") || _changeType.Equals("改定")))
                    {
                        if (_szrl082.rl08229 > (Convert.ToDecimal(_kp)))
                        {
                            //?? 转js前台处理
                        }
                    }
                    #endregion
                    #region 作番是否被内部精算
                    byte _rl01827 = this._szrl018Repository.GetModels(x => x.rl01801.Equals(_zuofanid)).Select(x => x.rl01827).FirstOrDefault();
                    if (_rl01827.Equals(3))
                    {
                        return OperateResultFactory.AjaxOperateResult(OperateResultType.Error, "作番已内部精算,不可保存!");
                    }
                    if (_rl01827.Equals(4))
                    {
        ...
        public IOperateResult Recognize(IRequestGetter context)
        {
            try
            {
                ...
                string changeType = context.GetValue<string>("changeType");
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    szrl082 ent_szrl082 = this._szrl082Repository.GetModels(x => x.rl08204.Equals(zuofanid) && x.rl08203.Equals(versionnumber)).FirstOrDefault();
                    ...
                    if (changeType.Equals("订正") || changeType.Equals("改定"))
                    {
                        ent_szrl082.rl08212 = DateTime.Now.ToString("yyyy/MM/dd");
        ...
        public IOperateResult Remove(IRequestGetter context)
        {
            try
            {
                ...
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    #endregion
                    #region 删除klbde
                    IQueryable<szrl083> ent_szrl083 = this._szrl083Repository.GetModels(x => x.rl08316.Equals(zuofanid) && x.rl08317.Equals(versionnumber));
                    #endregion
                    #region 删除aj
                    #endregion
                    #region 删除计划进度
        ...
        public void SaveVoucher_086(List<szrl086> vParams, string[] _param)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    if (vParams != null)
                    {
                        List<szrl086> context = IsNull_string(vParams, _param[0]);
        ...
        public IOperateResult GetKLBDEInfo(IRequestGetter vParams)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    rl08302s = Arry_short(rl08302s, rl08302s_or);
                    ...
                    foreach (var item in rl08302s)//一级目录
                    {
                        ...
                        rl08303s = Arry_short(rl08303s, rl08303s_or);
                            ...
                            if (m_szrl112 != null)
                            {
                                ...
                                foreach (var item3 in query_szrl083s)//明细
                                {
                                    if (item3.rl08302.Equals(item) && item3.rl08303.Equals(item2))
                                    {
                                        ...
                                        _s_083_3.rl08319 = item3.rl08319;
        ...
        /// <param name="vParams"></param>
        /// <returns></returns>
        public void SaveVoucher_083(List<szrl083> vParams, string[] _param)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    if (vParams != null)
                    {
                        foreach (var item in vParams)
                        {
                            ...
                            query_szrl083.rl08319 = query_szrl083.rl08319 ?? string.Empty;
                            if (string.IsNullOrWhiteSpace(query_szrl083.rl08301))
                            {
                                query_szrl083.rl08301 = null;
                                query_szrl083.rl08316 = _param[0];
                                query_szrl083.rl08317 = _param[1];
                                query_szrl083.rl08318 = _param[2];
                            ...
                            else
                            {
                                ...
                                szrl083 ent_szrl083 = this._szrl083Repository.Find(x => x.rl08301.Equals(query_szrl083.rl08301));
        ...
        public IEnumerable<szrl112> LevelMenu()
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    IEnumerable<szrl112> query_szrl112s = this._szrl112Repository.GetModels(x => x.rl11215.Equals(1) && !x.rl11205.Equals("其他")).ToArray();
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        using (var scope = _scopeFactory.CreateScope())
                        {
                            ...
                            foreach (DataRow dr in dt.Rows)
                            {
                                ...
                                item.rl08312 = Convert.ToDecimal(dr[excel.rl08312]);
                                if (!string.IsNullOrWhiteSpace(item.rl08304))
                                {
                                    ...
                                    {
                                        string _two = item.rl08304.Substring(0, 4);
                                        IQueryable<szrl112> sql_szrl112 = this._szrl112Repository.GetModels(x => x.rl11203.Equals(_two));
                                        item.rl08302 = sql_szrl112.Select(x => x.rl11202).FirstOrDefault();
                                        item.rl08303 = sql_szrl112.Select(x => x.rl11204).FirstOrDefault();
                                        item.rl08305 = sql_szrl112.Select(x => x.rl11204).FirstOrDefault();
                                        itemList.Add(item);
                                    }
                                    //szrl112 query_szrl112 = this._szrl112Repository.GetModels(x => x.rl11203.Equals(item.rl08304) && x.rl11204.Equals(item.rl08305) && item.rl08302.Contains(x.rl11205)).FirstOrDefault();
                                    //if (query_szrl112 != null)
                                    //{
                                    //    string _two = item.rl08304.Substring(2, 2);//
                                    //    IQueryable<szrl112> sql_szrl112 = this._szrl112Repository.GetModels(x => x.rl11203.Contains(_two) && x.rl11215.Equals(2) && x.rl11205.Equals(item.rl08304.Substring(0, 2)));
                                    //    string _two_name = sql_szrl112.Select(x => x.rl11204).FirstOrDefault();
                                    //    if (!string.IsNullOrWhiteSpace(_two_name) && _two_name == item.rl08303)
                                    //    {
                                    //        itemList.Add(item);
                                    //    }
                                    //}
        ...
        public Dictionary<string, string> dic_084()
        {
            ...
            try
            {
                ...
                {
                    IEnumerable<szrl112> query_szrl112s = this._szrl112Repository.GetModels(x => x.rl11215.Equals(1) && x.rl11205.Equals("其他")).ToArray();
                    foreach (var item in query_szrl112s)
                    {
                        d.Add(item.rl11204, item.rl11203);
                    }
                }
            }
            catch (Exception)
        ...
        /// <param name="vParams"></param>
        /// <returns></returns>
        public void SaveVoucher_084(List<szrl084> vParams, string[] _param)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    if (vParams != null)
                    {
                        foreach (var item in vParams)
                        {
                            ...
                            {
                                query_szrl084.rl08401 = null;
                                query_szrl084.rl08404 = "";
                                query_szrl084.rl08405 = "";
                                query_szrl084.rl08407 = "";
                                query_szrl084.rl08415 = _param[0];
                                query_szrl084.rl08416 = _param[1];
                                query_szrl084.rl08417 = _param[2];
        ...
        public IOperateResult GetajInfo(IRequestGetter context)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    string[] query_szrl084s_or = new string[] { "A", "C", "D2", "F", "G", "H", "J1", "J2", "J3", "J4", "J5", "J6", "J8", "M", "N" };
                    ...
                    int[] sortKeys = query_szrl084s.Select(x => Array.IndexOf(query_szrl084s_or, x.rl08402)).ToArray();
                    szrl084[] newdata = query_szrl084s.ToArray();
                    Array.Sort<int, szrl084>(sortKeys, newdata);
            ...
            {
                return OperateResultFactory.GridOperateResult(new List<AJ>());
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<szrl112> AjMenu()
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
        ...
        #region 与前一版本对比
        /// <summary>
        /// 获取上一版本 订正和改定时,内部修正为0,此时获取上一版本需要特殊处理
        /// </summary>
        /// <param name="versionnumber"></param>
        /// <param name="_changeType"></param>
        /// <returns></returns>
        private string GetLastVersion(string zuofanid, string versionnumber, string _changeType)
        {
            string last_versionnumber = string.Empty;
            string c_1 = versionnumber.Substring(0, 2);
            string c_2 = versionnumber.Substring(2, 2);
            string c_3 = versionnumber.Substring(4, 2);

            string c_1_1 = (Convert.ToInt32(c_1) - 1).ToString().PadLeft(2, '0');
            string c_2_1 = (Convert.ToInt32(c_2) - 1).ToString().PadLeft(2, '0');
            string c_3_1 = (Convert.ToInt32(c_3) - 1).ToString().PadLeft(2, '0');
            IQueryable<szrl082> _s = this._szrl082Repository.GetModels(x => x.rl08204.Equals(zuofanid));
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    {
                        case "订正":
                            string c_3_2 = _s.Where(x => x.rl08203.Substring(0, 2).Equals(c_1_1)).Max(m => m.rl08203.Substring(4, 2));
                            last_versionnumber = c_1_1 + c_2 + c_3_2;
                            break;
                        case "改定":
                            string c_2_2 = _s.Where(x => x.rl08203.Substring(2, 2).Equals(c_2_1)).Max(m => m.rl08203.Substring(4, 2));
                            last_versionnumber = c_1 + c_2_1 + c_2_2;
                            break;
                        case "内部修正":
                            last_versionnumber = c_1 + c_2 + c_3_1;
                            break;
                        default:
                            break;
                    }
        ...
        /// <param name="vParams"></param>
        /// <returns></returns>
        public IOperateResult GetpvcnbInfo(IRequestGetter vParams)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    string zuofanid = vParams.GetValue<string>("zuofanid");
                    string versionnumber = vParams.GetValue<string>("versionnumber");
                    if (versionnumber.Equals("000000"))//如果是初会版本 不显示
                    {
                        return OperateResultFactory.GridOperateResult(new List<PreviousVersionCBN>());
                    }
                    string _changeType = this._szrl082Repository.GetModels(x => x.rl08204.Equals(zuofanid) && x.rl08203.Equals(versionnumber)).Select(x => x.rl08234).FirstOrDefault();
                    string last_versionnumber = GetLastVersion(zuofanid, versionnumber, _changeType);//获取上一个版本号
                    #region 遍历组合model
                    IEnumerable<szrl083> query_szrl083s = this._szrl083Repository.GetModels(x => x.rl08316.Equals(zuofanid) && x.rl08317.Equals(versionnumber)).ToArray();//当前list
                    IQueryable<szrl083> list_query_szrl083s = this._szrl083Repository.GetModels(x => x.rl08316.Equals(zuofanid) && x.rl08317.Equals(last_versionnumber));//上一版本list
                    string[] rl08302s = query_szrl083s.Select(x => x.rl08302).Distinct().ToArray();
                    rl08302s = Arry_short(rl08302s, rl08302s_or);
                    List<PreviousVersionCBN> new_query_szrl083s = new List<PreviousVersionCBN>();
                    foreach (var item in rl08302s)//一级目录
                    {
                        string[] rl08303s = query_szrl083s.Where(x => x.rl08302.Equals(item)).Select(x => x.rl08303).Distinct().ToArray();
                        rl08303s = Arry_short(rl08303s, rl08303s_or);
                        PreviousVersionCBN _s_083_1 = new PreviousVersionCBN();
                        _s_083_1.b_rl08302 = item;
                        _s_083_1.b_rl08310 = query_szrl083s.Where(x => x.rl08302.Equals(item)).Sum(s => s.rl08309);
                        _s_083_1.b_rl08314 = query_szrl083s.Where(x => x.rl08302.Equals(item)).Sum(s => s.rl08313);
                        _s_083_1.f_rl08302 = item;
                        _s_083_1.f_rl08310 = list_query_szrl083s.Where(x => x.rl08302.Equals(item)).Sum(s => ((decimal?)s.rl08309)).GetValueOrDefault();
                        _s_083_1.f_rl08314 = list_query_szrl083s.Where(x => x.rl08302.Equals(item)).Sum(s => ((decimal?)s.rl08313)).GetValueOrDefault();
                        new_query_szrl083s.Add(_s_083_1);
                        foreach (var item2 in rl08303s)//二级目录
                        {
                            IQueryable<szrl112> m_szrl112 = this._szrl112Repository.GetModels(x => x.rl11202.Equals(item) && x.rl11204.Equals(item2));
                            if (m_szrl112 != null)
                            {
                                PreviousVersionCBN _s_083_2 = new PreviousVersionCBN();
                                _s_083_2.b_rl08303 = item2;
                                _s_083_2.b_rl08310 = query_szrl083s.Where(x => x.rl08302.Equals(item) && x.rl08303.Equals(item2)).Sum(s => s.rl08309);
                                _s_083_2.b_rl08314 = query_szrl083s.Where(x => x.rl08302.Equals(item) && x.rl08303.Equals(item2)).Sum(s => s.rl08313);
                                _s_083_2.f_rl08303 = item2;
                                _s_083_2.f_rl08310 = list_query_szrl083s.Where(x => x.rl08302.Equals(item) && x.rl08303.Equals(item2)).Sum(s => ((decimal?)s.rl08309)).GetValueOrDefault();
                                _s_083_2.f_rl08314 = list_query_szrl083s.Where(x => x.rl08302.Equals(item) && x.rl08303.Equals(item2)).Sum(s => ((decimal?)s.rl08313)).GetValueOrDefault();
                                new_query_szrl083s.Add(_s_083_2);
                                foreach (var item3 in query_szrl083s)//明细
                                {
                                    if (item3.rl08302.Equals(item) && item3.rl08303.Equals(item2))
                                    {
                                        PreviousVersionCBN _s_083_3 = new PreviousVersionCBN();
                                        _s_083_3.b_rl08301 = item3.rl08301;
                                        _s_083_3.b_rl08304 = this._szrl112Repository.GetModels(x => x.rl11201.Equals(item3.rl08304)).Select(x => x.rl11203).FirstOrDefault();
                                        _s_083_3.b_rl08305 = item3.rl08305;
                                        _s_083_3.b_rl08306 = item3.rl08306;
                                        _s_083_3.b_rl08307 = item3.rl08307;
                                        _s_083_3.b_rl08308 = item3.rl08308;
                                        _s_083_3.b_rl08309 = item3.rl08309;
                                        _s_083_3.b_rl08311 = item3.rl08311;
                                        _s_083_3.b_rl08312 = item3.rl08312;
                                        _s_083_3.b_rl08313 = item3.rl08313;
                                        _s_083_3.b_rl08315 = item3.rl08315;
                                        _s_083_3.b_rl08316 = item3.rl08316;
                                        _s_083_3.b_rl08317 = item3.rl08317;
                                        _s_083_3.b_rl08318 = item3.rl08318;
                                        #region 对上一版本model赋值 
                                        szrl083 item4 = list_query_szrl083s.Where(x => x.rl08301.Equals(item3.rl08319)).FirstOrDefault();
                                        if (item4 != null)
                                        {
                                            _s_083_3.f_rl08301 = item4.rl08301;
                                            _s_083_3.f_rl08304 = this._szrl112Repository.GetModels(x => x.rl11201.Equals(item4.rl08304)).Select(x => x.rl11203).FirstOrDefault();
                                            _s_083_3.f_rl08305 = item4.rl08305;
                                            _s_083_3.f_rl08306 = item4.rl08306;
                                            _s_083_3.f_rl08307 = item4.rl08307;
                                            _s_083_3.f_rl08308 = item4.rl08308;
                                            _s_083_3.f_rl08309 = item4.rl08309;
                                            _s_083_3.f_rl08311 = item4.rl08311;
                                            _s_083_3.f_rl08312 = item4.rl08312;
                                            _s_083_3.f_rl08313 = item4.rl08313;
                                            _s_083_3.f_rl08315 = item4.rl08315;
                                            _s_083_3.f_rl08316 = item4.rl08316;
                                            _s_083_3.f_rl08317 = item4.rl08317;
                                            _s_083_3.f_rl08318 = item4.rl08318;
                                        }
                                        #endregion
                                        new_query_szrl083s.Add(_s_083_3);
                                    }
        ...
        /// 模糊匹配排序
        /// </summary>
        /// <param name="s1">原数组</param>
        /// <param name="s2">排序数组</param>
        /// <returns></returns>
        private string[] Arry_short(string[] s1, string[] s2)
        {
        ...
        public List<szrl082> VersioNnumber(IRequestGetter context)
        {
            try
            {
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    ...
                    query_szrl082 = this._szrl082Repository.GetModels(x => x.rl08204.Equals(zuofanid)).OrderByDescending(o => o.rl08203).ToList();
        ...
        public IOperateResult GetSzrl019Info(IPageContext context)
        {
            try
            {
                ...
                using (IDbContextScope scope = this._scopeFactory.CreateScope())
                {
                    string _zuofanid = context.GetValue<string>("zuofanid");
                    IQueryable<szrl019> _szrl019s = this._szrl019Repository.GetModels(x => x.rl01906.Equals(_zuofanid) && x.rl01964.Equals(1)).OrderBy(x => x.rl01903);
                    pagedList = _szrl019s.ToPagedList<szrl019>(context);
                    return OperateResultFactory.GridOperateResult(pagedList);
                }
            }
            catch (Exception ex)
            {
                return OperateResultFactory.GridOperateResult(new List<szrl019>());
            }
        }
